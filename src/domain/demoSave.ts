  ...
  intro_lushi: {
    ...
    nodes: [
      ...
      },
      {
        ...
        title: "宿舍醒来",
        speaker: "小娴",
        text: "别闹。你刚醒，先别急着起身。这里是鹿石宗，你昏倒在山脚下，是我和小张把你带回来的。",
        mode: "dialogue",
        visualStage: "intro_dormitory",
        scene: "dormitory",
      },
      ...
      },
      {
        ...
        title: "广场认路",
        speaker: "小张",
        text: "对了，正式介绍一下——在下张真人，鹿石宗大师兄。这是小娴，你大师姐。",
        mode: "dialogue",
      ...
      },
      {
        ...
        title: "广场认路",
        speaker: "小张",
        text: "以后修炼上不懂的——问我。炼器、练功、宗门规矩，本大师兄都懂一点。",
        mode: "dialogue",
        visualStage: "intro_plaza",
        scene: "plaza",
      },
      {
        ...
        title: "广场认路",
        speaker: "小娴",
        text: "他说的“一点”，通常真的只有一点。走吧，真人在大厅等你。",
        mode: "dialogue",
        visualStage: "intro_plaza",
        scene: "plaza",
        continueLabel: "前往大厅",
