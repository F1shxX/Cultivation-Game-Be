  ...
  intro_lushi: {
    ...
    nodes: [
...

      {
        ...
        title: "宿舍醒来",
        speaker: "小娴",
        text: "感觉怎么样？不急，慢慢来。真人吩咐了，等你醒了带去大厅见他。",
        mode: "choice",
        visualStage: "intro_dormitory",
        scene: "dormitory",
        choices: [
...

      {
        ...
        title: "宿舍醒来",
        speaker: "小张",
        text: "你不知道——那天在山脚下发现你的时候，你浑身是泥，就剩一只眼睛露在外面。我一看，还有气！赶紧叫师姐来帮忙。这就叫——",
        mode: "dialogue",
        visualStage: "intro_dormitory",
        scene: "dormitory",
      },
...

      {
        ...
        title: "广场认路",
        speaker: "小娴",
        text: "修仙界要结了金丹的修士才配称'真人'。他这个是自己封的——你叫他大师兄就好。",
        mode: "dialogue",
        visualStage: "intro_plaza",
        scene: "plaza",
      },
...

      {
        ...
        title: "大殿初见",
        speaker: "鹿真人",
        text: "你的灵根我探过了。五种俱全——金木水火土。灵根愈杂，修行愈缓。此乃常理，你当知晓。",
        mode: "dialogue",
        visualStage: "intro_hall",
        scene: "hall",
      },

      {
        ...
        title: "大殿初见",
        speaker: "小张",
        text: "五种那可是相当杂了——师弟你以后得用功。不过没事，大师兄盯着你。",
        mode: "dialogue",
        visualStage: "intro_hall",
        scene: "hall",
      },
...

      {
        ...
        title: "入门功法",
        speaker: "鹿真人",
        text: "这两本也可修。金芒诀锋锐，焰心诀爆烈。皆学了去，日后如何搭配——自行琢磨。",
        mode: "dialogue",
        visualStage: "intro_hall",
        scene: "hall",
      },
      ...
      {
        id: "xiaoxian-guidance",
        title: "入门功法",
        speaker: "小娴",
        text: "师弟，真人的意思是鹿花诀先修扎实，打牢底子。另外两本可以一起修——多学几门，将来便能搭配组合。你灵根虽杂，却是什么都能学，或许反倒适合这般路子。",
        mode: "dialogue",
        visualStage: "intro_hall",
        scene: "hall",
      },
...

      {
        ...
        title: "真人离去",
        speaker: "小张",
        text: "好了，师弟。真人走了，大师兄先带你四处转转，认认路。明天开始教你修炼——三本功法，够你忙一阵的。走走走。",
        mode: "dialogue",
        visualStage: "intro_hall",
        scene: "hall",
        continueLabel: "结束开场",
